    ...
    <>
      <div className="relative  text-white font-medium">
        ...
        <div data-aos="fade-up"  data-aos-delay="300"className=" absolute top-[40%] left-0 right-0 flex items-center justify-center flex-col">
          {" "}
          <h1 className="text-6xl font-['viga'] text-white">
          ...
          <button className="border duration-500 ease-in hover:border-primary text-lg py-3 px-5 hover:bg-primary ">View Full Menu</button>
        </div>
      </div>
    </>
  );
